...
//静态方法：增加学生
collectionSchema.statics.add = function(json,callback){
...
//静态方法：得到全部课程
collectionSchema.statics.getAll = function(callback){
...
collectionSchema.statics.change = function(newJSON){
...
collectionSchema.statics.delete = function(arr,callback){
    var _arr = [];
...
collectionSchema.statics.zuchu = function(arr,sc,zj,je,select,pay,callback){
    // console.log(select);
    var _arr = [];
    arr.forEach(function(item){
        // console.log(item);
...
collectionSchema.statics.guihuan = function(arr,callback){
    // console.log(select);
    var _arr = [];
    console.log(arr);
    arr.forEach(function(item){
